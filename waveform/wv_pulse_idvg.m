function [] = wv_pulse_idvg(wavename, vd, ... 
...
% datasize: number of measure points in a period
    ...
    %% vg parameter set
    % step_time=rise_time+delay_time+stair_time+fall_time+zero_time;
    vg_rise_time  = vg_step_time/10;
    vg_delay_time = vg_step_time/10;
    vg_stair_time = vg_step_time*4/10;
    vg_fall_time  = vg_rise_time;
    vg_zero_time  = vg_step_time*3/10;

    % Gate voltage range
    vg_step_num = (vg_stop-vg_start)/vg_step_len + 1;
    % vd parameter set
    vd_rise_time = vg_rise_time;
    vd_step_time = vg_step_time*vg_step_num;
...
%% create pattern
    ...
    for i=1:vg_step_num
        ...
        calllib('wgfmu', 'WGFMU_addVector', wavename1, vg_fall_time, 0);
        calllib('wgfmu', 'WGFMU_addVector', wavename1, vg_zero_time, 0);
    end
...
%% measurement event set
    ...
    calllib('wgfmu', 'WGFMU_setMeasureEvent', wavename1, eventname, ...
        ...
        vg_step_num, vg_step_time, vg_stair_time-vg_delay_time, ...
